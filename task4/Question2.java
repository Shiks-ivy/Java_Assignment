...
public class Question2 {
    ...
    static void isPrime() {
        ...
        for (int i = 2; i <= numberToTest / 2; ++i) {
            ...
            if (numberToTest % i == 0) {// cross checking for nonprime number
                flag = true;
                break;
            }
        }
    ...
    public static void main(String[] args) {// this main method is used to display prime numbers between 1 to 500.
